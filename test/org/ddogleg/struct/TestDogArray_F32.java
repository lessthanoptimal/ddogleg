...
public class TestDogArray_F32 extends ChecksDogArrayPrimitive<DogArray_F32> {
	@Test void range() {
		DogArray_F32 alg = DogArray_F32.range(-1, 20);
	...
	@Test void count() {
		DogArray_F32 alg = DogArray_F32.array(0, 0, 1, 1, 1);
	...
	@Test void isEquals_tol() {
		DogArray_F32 alg = DogArray_F32.array(0, 0, 1, 1, 4);
		assertTrue(alg.isEquals(DogArray_F32.array(0, 0, 1, 1, 4), 0.5f));
		assertFalse(alg.isEquals(DogArray_F32.array(0, 0, 1, 1), 0.5f));
		assertTrue(alg.isEquals(DogArray_F32.array(0.5f, 0, 1, 1, 4), 0.5f));
		assertFalse(alg.isEquals(DogArray_F32.array(0.5001f, 0, 1, 1, 4), 0.5f));
	}
	...
	@Override public DogArray_F32 declare( int maxsize ) {
		return new DogArray_F32(maxsize);
	}

	@Override public void push( DogArray_F32 queue, double value ) {
		queue.push((float)value);
	}

	@Override public void insert( DogArray_F32 queue, int index, double value ) {
		queue.insert(index, (float)value);
	}

	@Override public void check( DogArray_F32 queue, int index, double value ) {
	...
	@Test void forEach() {
		DogArray_F32 alg = DogArray_F32.array(1, 2, 3, 4, 5);
		var cpy = new DogArray_F32(alg.size);
		alg.forEach(cpy::add);
