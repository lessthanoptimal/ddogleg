...
public class TestBigDogArray_I8 extends ChecksBigDogArray<byte[]> {
	...
	@Test void isEquivalent() {
		...
		var a = new BigDogArray_I8(10, 5, BigDogGrowth.GROW);
		var b = new BigDogArray_I8(10, 4, BigDogGrowth.GROW);
	...
	@Override public void fillRandom( BigDogArrayBase<byte[]> _array ) {
		var array = (BigDogArray_I8)_array;
		array.applyIdx(0, array.size, ( idx, v ) -> (byte)rand.nextInt());
	}

	@Override public Object get( BigDogArrayBase<byte[]> _array, int index ) {
		var array = (BigDogArray_I8)_array;
		return array.get(index);
	}

	@Override public void copy( BigDogArrayBase<byte[]> _src, BigDogArrayBase<byte[]> _dst ) {
		var src = (BigDogArray_I8)_src;
		var dst = (BigDogArray_I8)_dst;
