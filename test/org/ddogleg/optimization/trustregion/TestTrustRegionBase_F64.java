...
public class TestTrustRegionBase_F64 {
	 ...
	 */
	@Test void checkConvergenceFTest_radius() {
		MockTrustRegionBase_F64 alg = createFixedCost(1, 0.5);
	...
	protected void considerUpdate( double fx_candiate, double fx, double predictedReduction, double stepLength,
		...
		var alg = new MockTrustRegionBase_F64(null);
	...
	private MockTrustRegionBase_F64 createFixedCost( double cost, double predictedReduction ) {
		var update = new MockParameterUpdate() {
			@Override 	public double getPredictedReduction() {
	...
	private static class MockParameterUpdate implements TrustRegionBase_F64.ParameterUpdate<DMatrixRMaj> {
		@Override public void initialize( TrustRegionBase_F64<DMatrixRMaj, ?> base,
								int numberOfParameters, double minimumFunctionValue ) {}

		@Override public void initializeUpdate() {}

		@Override public void computeUpdate( DMatrixRMaj p, double regionRadius ) {}

		@Override public double getPredictedReduction() {return 0;}

		@Override public double getStepLength() {return 0;}

		@Override public void setVerbose( @Nullable PrintStream out, int level ) {}
	}

	@SuppressWarnings({"NullAway"})
	private static class MockTrustRegionBase_F64 extends TrustRegionBase_F64<DMatrixRMaj, HessianMath> {

		public MockTrustRegionBase_F64( @Nullable ParameterUpdate<DMatrixRMaj> parameterUpdate ) {
			super(parameterUpdate, new HessianMath_DDRM());
		}

		@Override protected double cost( DMatrixRMaj x ) {return 0;}

		@Override protected void functionGradientHessian( DMatrixRMaj x, boolean sameStateAsCost,
