...
/**
 * Implementation of {@link BigDogArray} for long[].
 *
 * @author Peter Abeles
 */
public class BigDogArray_I64 extends BigDogArray<long[]> {

	// WARNING: BigDogArray_I64 is a template for all the other BigDogArray classes. Only modify BigDogArray_I64.
	...
	public BigDogArray_I64( int initialAllocation, int blockSize, Growth growth ) {
		super(initialAllocation, blockSize, growth);
	}

	@Override protected long[] newArrayInstance( int size ) {
