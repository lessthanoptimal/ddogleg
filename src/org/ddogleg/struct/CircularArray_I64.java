...
public class CircularArray_I64 extends CircularArrayBase {
	...
	public CircularArray_I64 setTo( CircularArray_I64 original ) {
		if (this.data.length != original.data.length) {
			this.data = new long[original.data.length];
		}
	...
	public CircularArray_I64 copy() {
		return new CircularArray_I64().setTo(this);
	}
