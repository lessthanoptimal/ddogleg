...
/**
 * Implementation of {@link BigDogArrayBase} for int[].
 *
 * @author Peter Abeles
 */
public class BigDogArray_I32 extends BigDogArrayBase<int[]> {
	...
	public BigDogArray_I32( int initialAllocation, int blockSize, BigDogGrowth growth ) {
		super(initialAllocation, blockSize, growth, int[]::new, ( a, b ) -> {});
	}
	...
	/**
	 * Appends a single value to the end of the array. identical to {@link #append(int)}.
	 *
	 * @param value (Input) The new value which is to be added
	 */
	 ...
	 * of each other.
	 */
	public boolean isEquivalent( BigDogArray_I32 o ) {
		if (size != o.size)
			return false;
		...
		for (int i = 0; i < size; i++) {
			...
			// compare the values
			if (blocks.data[blockA][idxA] != o.blocks.data[blockB][idxB])
				return false;
