 ...
 * @author Peter Abeles
 */
public class EvaluateLevenbergMarquardtNew extends UnconstrainedLeastSquaresEvaluator_DDRM {

	public EvaluateLevenbergMarquardtNew(boolean verbose) {
		super(verbose, true);
	}
...
//		config.mixture = 1;
	...
	public static void main( String args[] ) {
		EvaluateLevenbergMarquardtNew eval = new EvaluateLevenbergMarquardtNew(false);
