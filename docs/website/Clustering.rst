...
`ExampleClustering.java <https://github.com/lessthanoptimal/ddogleg/blob/v0.10/examples/src/org/ddogleg/example/ExampleClustering.java>`_

.. literalinclude:: examples/ExampleClustering.java
   :language: java
   :linenos:
   :tab-width: 4
   :dedent: 2
